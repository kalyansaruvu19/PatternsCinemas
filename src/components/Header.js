...
export const Header = () => {
  ...
  const activeClass =
    "text-base block py-2 pr-4 pl-3 text-white bg-green-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white";
  const inActiveClass =
  ...
  return (
    <header>
      <nav className="bg-black border-b-2 border-green-500 px-2 sm:px-4 py-2 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
